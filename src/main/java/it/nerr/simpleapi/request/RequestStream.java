...
import it.nerr.simpleapi.http.client.ClientRequest;
import it.nerr.simpleapi.http.client.ClientResponse;
import it.nerr.simpleapi.http.client.WebClient;
import it.nerr.simpleapi.response.ResponseFunction;
import it.nerr.simpleapi.util.LogUtil;
...
import static it.nerr.simpleapi.util.LogUtil.format;
